namespace Tanglebeep.Speech {
    ...
    internal static class ModStrings {
        ...
        /// <summary>Active abilities not tied to a real job — chiefly weapon masteries, learned from the
        /// pseudo-job GENERIC. Grouped under one catch-all row.</summary>
        public const string OtherAbilitiesRow = "other abilities";
