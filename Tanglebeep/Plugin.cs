...
using Tanglebeep.Dev;
using Tanglebeep.Gameplay;
using Tanglebeep.Native;
using Tanglebeep.Overlays;
...
namespace Tanglebeep {
    ...
    public partial class Plugin : BaseUnityPlugin {
        public const string PluginGuid = "io.ahicks.tanglebeep";
        public const string PluginName = "Tanglebeep";
        ...
        private void Awake() {
            ...
            // or absent NVDA must not hang or corrupt anything: TANGLEBEEP_NO_SPEECH=1.
            _speech = new PrismSpeech();
            if (Environment.GetEnvironmentVariable("TANGLEBEEP_NO_SPEECH") == "1") {
                Log.Info("Speech disabled (TANGLEBEEP_NO_SPEECH=1): Prism not loaded; spoken text still captured for /speech");
            } else {
            ...
            // Dev driver (eval + speech tap). On by default, loopback only; TANGLEBEEP_NO_DEV=1 disables.
            _devServer.Start();
        }
